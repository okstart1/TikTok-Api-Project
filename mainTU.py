...
hashtags = [
    "soccerpositionalawareness",
    "soccerdecisionmaking",
    "soccerformations",
    "soccergamephases",
    "soccersetpieces"
]

# Maximum number of videos to download per keyword/hashtag
max_videos = 200
...
async def search_and_download_videos(keyword, is_hashtag=False):
    ...
    try:
        async with TikTokApi() as api:
            ...
            reformat_json(output_file, formatted_output_file, keyword)

    except Exception as e:
        print(f"An error occurred: {e}")

def reformat_json(input_path, output_path, keyword):
    ...
    for video in video_list:
        ...
        formatted_video = {
            "text": post_text,
            "tags": keyword,
            "pillars": "Tactical Understanding",
            "user_type": "coach",
